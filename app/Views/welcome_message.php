...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="Buku" target="_blank">Buku</a></li>
            <li class="menu-item hidden"><a href="BukuPaket" target="_blank">Buku Paket</a></li>
            <li class="menu-item hidden"><a href="KategoriBuku" target="_blank">Kategori Buku</a></li>
            <li class="menu-item hidden"><a href="PinjamBuku" target="_blank">Pinjam Buku</a></li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h2>
            <li>Nama : NUNISKA DWI KAMAYANTI</li>
            <li>NIM : 221101018</li>
            </h2>
